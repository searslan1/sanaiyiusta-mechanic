  ...
  return (
    <div className="container px-4 py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-bold text-gray-900">Talep Detayı</h1>
      </div>
      ...
      <Card className="mb-6">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-medium text-gray-900">Yağ Değişimi</h3>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p className="text-sm font-medium">{requestId}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm font-medium">25 Mayıs 2023</p>
            </div>
            <div>
              <p className="text-xs text-gray-500">Tercih Edilen Saat</p>
              <p className="text-sm font-medium">Sabah (09:00 - 12:00)</p>
            </div>
          </div>
      ...
      {/* Responses */}
      <div className="mb-6">
        <h3 className="font-medium text-gray-900 mb-4">Ustalardan Yanıtlar (3)</h3>
        ...
        <Tabs defaultValue="all">
          ...
          <TabsContent value="accepted" className="space-y-4">
            <div className="flex flex-col items-center justify-center py-8 text-center">
              <p className="text-gray-500">Henüz kabul edilmiş yanıt bulunmuyor.</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
