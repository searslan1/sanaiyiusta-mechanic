...
import { CheckCircle, ArrowRight, Calendar, Clock, MapPin } from "lucide-react"
import Link from "next/link"

export default function NewAppointmentConfirmationPage() {
  return (
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm font-medium">APT-2023-045</p>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm font-medium">25 Mayıs 2023, 14:30</p>
              </div>
            </div>
